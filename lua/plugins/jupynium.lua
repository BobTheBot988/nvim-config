...
return {
  {
    ...
    -- If you also need the Python package, install it yourself (pip/conda).
    -- build = "uv pip install --user -U jupynium",
    ft = { "python", "markdown" }, -- load when it matters
    dependencies = {
